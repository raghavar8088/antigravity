# Browser-Automation Prompt Pack Part 2
...
## Issue 1: Observed bridge failure: Failed to submit prompt to ChatGPT
...
## Issue 2: Observed bridge failure: Timed out waiting for ChatGPT to finish responding
