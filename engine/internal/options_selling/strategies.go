...
//   - All strategies use OTM strikes (0.6% - 1.2%) for higher Probability of Profit (POP).
//   - Bullish signals trigger SOLD PUTS.
//   - Bearish signals trigger SOLD CALLS.
//   - TakeProfitPct: 0.60 (Exit when 60% of premium has decayed).
//   - StopLossPct: 1.20 (Exit when premium has doubled + 20% to allow for noise).
