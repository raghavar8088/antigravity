...
const PRIMARY_NAV: NavItem[] = [
  ...
  // A PEER of the Delta desk, not a child of it. It runs the same engine on a
  // different market — lots instead of contracts, pips instead of ticks, swap
  // instead of funding, an account stopped out on margin level — and neither
  // desk depends on the other, so the nav lists them side by side.
  { href: "/forex-paper-trading", label: "Forex Paper Trading", icon: ic.globe },
