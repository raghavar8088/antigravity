      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "var(--radius-card)", overflow: "hidden" }}>
        ...
        >
          {activeModule === "dashboard"
            ...
            ? "BTC Spot Scalper — Thirty 1m strategies on Delta Exchange candle data (default BTCUSD), $100 paper wallet, max four concurrent clips, tuned TP/SL execution, and round-trip fee drag modeled (~0.15% notional)."
