...
const READ_ACTIONS = ["state", "account", "positions", "closed-positions", "daily-pnl", "orders", "roster", "reconciliation", "audit"];
const WRITE_ACTIONS = ["arm", "disarm", "close-all", "strategy", "kill-switch", "clear-history"];
