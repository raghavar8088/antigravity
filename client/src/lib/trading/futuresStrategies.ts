 ...
 *
 * Trade Engine keeps only the production CORE winner roster active here.
 * Research and generated pools remain removed so the active desk does not
 * silently reintroduce unvetted strategies.
 */
...
export const FUTURES_STRAT_DEFS: readonly FuturesStratDef[] = [
  { id: 91, name: "Trend_Continuation_Long", category: "Trend", signalKey: "TREND_CONT_LONG", slPct: 0.5, tpPct: 1.5, cooldownMin: 8, holdMinutes: 40, confluenceMin: 5, styles: ["scalp"], playbooks: ["trend"], templateFamily: "TREND_CONT" },
  { id: 92, name: "Trend_Continuation_Short", category: "Trend", signalKey: "TREND_CONT_SHORT", slPct: 0.5, tpPct: 1.5, cooldownMin: 8, holdMinutes: 40, confluenceMin: 5, styles: ["scalp"], playbooks: ["trend"], templateFamily: "TREND_CONT" },
  ...
  { id: 111, name: "MTF_Trend_Align_Long", category: "MTF Trend", signalKey: "MTF_TREND_ALIGN_LONG", slPct: 0.5, tpPct: 1.55, cooldownMin: 8, holdMinutes: 50, confluenceMin: 5, requiresHtf: true, styles: ["scalp", "day"], playbooks: ["trend"], templateFamily: "MTF_TREND_ALIGN" },
  { id: 112, name: "MTF_Trend_Align_Short", category: "MTF Trend", signalKey: "MTF_TREND_ALIGN_SHORT", slPct: 0.5, tpPct: 1.55, cooldownMin: 8, holdMinutes: 50, confluenceMin: 5, requiresHtf: true, styles: ["scalp", "day"], playbooks: ["trend"], templateFamily: "MTF_TREND_ALIGN" },
  ...
  { id: 131, name: "SmartMoney_Accum_Long", category: "Smart Money", signalKey: "SM_ACCUM_LONG", slPct: 0.5, tpPct: 1.55, cooldownMin: 8, holdMinutes: 50, confluenceMin: 6, styles: ["scalp", "day"], playbooks: ["momentum"], templateFamily: "SM_ACCUM" },
  { id: 132, name: "SmartMoney_Distrib_Short", category: "Smart Money", signalKey: "SM_DISTRIB_SHORT", slPct: 0.5, tpPct: 1.55, cooldownMin: 8, holdMinutes: 50, confluenceMin: 6, styles: ["scalp", "day"], playbooks: ["momentum"], templateFamily: "SM_DISTRIB" },
  ...
  { id: 151, name: "OpeningDrive_Long", category: "Session", signalKey: "OPEN_DRIVE_LONG", slPct: 0.5, tpPct: 1.5, cooldownMin: 5, holdMinutes: 30, confluenceMin: 5, styles: ["scalp"], playbooks: ["breakout"], templateFamily: "OPENING_DRIVE" },
  { id: 152, name: "OpeningDrive_Short", category: "Session", signalKey: "OPEN_DRIVE_SHORT", slPct: 0.5, tpPct: 1.5, cooldownMin: 5, holdMinutes: 30, confluenceMin: 5, styles: ["scalp"], playbooks: ["breakout"], templateFamily: "OPENING_DRIVE" },
];
