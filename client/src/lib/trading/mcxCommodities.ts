...
export const MCX_COMMODITIES: MCXCommodity[] = [
  ...
  },
  {
    ...
    name: "Silver Mini",
    searchQuery: "SILVERM",
    searchQueries: ["SILVERM", "SILVER MINI", "SILVER"],
  ...
  },
  {
    id: "ALUMINIUM",
    name: "Aluminium",
    searchQuery: "ALUMINIUM",
    searchQueries: ["ALUMINIUM", "ALUMINIUM MINI"],
    symbolHints: ["ALUMINIUM", "ALUMINI"],
    unit: "₹/kg",
    lotSize: 5000,
    iv: 0.24,
    strikeStep: 2.5,
  ...
  },
  {
    ...
    name: "Zinc",
    searchQuery: "ZINC",
    searchQueries: ["ZINC", "ZINC MINI"],
    symbolHints: ["ZINC", "ZINCMINI"],
    unit: "₹/kg",
    lotSize: 5000,
    iv: 0.26,
    strikeStep: 2.5,
  ...
  },
  {
    ...
    name: "Lead",
    searchQuery: "LEAD",
    searchQueries: ["LEAD", "LEAD MINI"],
    symbolHints: ["LEAD", "LEADMINI"],
    unit: "₹/kg",
    lotSize: 5000,
    iv: 0.25,
    strikeStep: 1,
  ...
  },
  {
    ...
    name: "Nickel",
    searchQuery: "NICKEL",
    searchQueries: ["NICKEL", "NICKEL MINI"],
    symbolHints: ["NICKEL", "NICKELMINI"],
    unit: "₹/kg",
    lotSize: 1500,
    iv: 0.32,
    strikeStep: 5,
