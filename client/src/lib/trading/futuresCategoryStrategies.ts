...
// ─── Category 3 — Swing Trading (640–659) ────────────────────────────────────
// Primary TF: 4h | Hold: 1–14 days | Leverage: 8× (max 10×) | SL: 1.0–2.5% | TP:SL ≥ 2.0
// Confluence min: 6 (category default; tighter than scalp/day).
// requiresHtf strategies use the intra-day context (htf5_/htf15_) as a "do-no-harm"
// gate — block swing-long when micro trend is hard down, etc. Real HTF (daily) is
// not yet wired through buildSignalInputs.

export const SWING_TRADING_STRATEGIES: ReadonlyArray<FuturesStratDef> = [
  { id: 640, name: "SWG_Trend_Ride_Long",     category: "Swing Trading", signalKey: "SWG_TREND_RIDE_LONG",   tradingCategory: "swing_trading", templateFamily: "swg_trend_ride",     primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.5, tpPct: 3.5, holdMinutes: 5760,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 641, name: "SWG_Trend_Ride_Short",    category: "Swing Trading", signalKey: "SWG_TREND_RIDE_SHORT",  tradingCategory: "swing_trading", templateFamily: "swg_trend_ride",     primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.5, tpPct: 3.5, holdMinutes: 5760,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 642, name: "SWG_MACD_Cross_Long",     category: "Swing Trading", signalKey: "SWG_MACD_CROSS_LONG",   tradingCategory: "swing_trading", templateFamily: "swg_macd_cross",     primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.2, tpPct: 2.8, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 643, name: "SWG_MACD_Cross_Short",    category: "Swing Trading", signalKey: "SWG_MACD_CROSS_SHORT",  tradingCategory: "swing_trading", templateFamily: "swg_macd_cross",     primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.2, tpPct: 2.8, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 644, name: "SWG_Breakout_4h_Long",    category: "Swing Trading", signalKey: "SWG_BREAKOUT_4H_LONG",  tradingCategory: "swing_trading", templateFamily: "swg_breakout_4h",    primaryBarInterval: "4h", requiresHtf: false, slPct: 1.8, tpPct: 4.0, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 645, name: "SWG_Breakout_4h_Short",   category: "Swing Trading", signalKey: "SWG_BREAKOUT_4H_SHORT", tradingCategory: "swing_trading", templateFamily: "swg_breakout_4h",    primaryBarInterval: "4h", requiresHtf: false, slPct: 1.8, tpPct: 4.0, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 646, name: "SWG_Pivot_Bounce_Long",   category: "Swing Trading", signalKey: "SWG_PIVOT_BOUNCE_LONG", tradingCategory: "swing_trading", templateFamily: "swg_pivot_bounce",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.4, tpPct: 3.0, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 647, name: "SWG_Pivot_Bounce_Short",  category: "Swing Trading", signalKey: "SWG_PIVOT_BOUNCE_SHORT",tradingCategory: "swing_trading", templateFamily: "swg_pivot_bounce",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.4, tpPct: 3.0, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 648, name: "SWG_Donchian_4h_Long",    category: "Swing Trading", signalKey: "SWG_DONCHIAN_4H_LONG",  tradingCategory: "swing_trading", templateFamily: "swg_donchian_4h",    primaryBarInterval: "4h", requiresHtf: false, slPct: 1.6, tpPct: 3.8, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 649, name: "SWG_Donchian_4h_Short",   category: "Swing Trading", signalKey: "SWG_DONCHIAN_4H_SHORT", tradingCategory: "swing_trading", templateFamily: "swg_donchian_4h",    primaryBarInterval: "4h", requiresHtf: false, slPct: 1.6, tpPct: 3.8, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 650, name: "SWG_RSI_Diverge_Long",    category: "Swing Trading", signalKey: "SWG_RSI_DIVERGE_LONG",  tradingCategory: "swing_trading", templateFamily: "swg_rsi_divergence", primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.3, tpPct: 2.8, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 651, name: "SWG_RSI_Diverge_Short",   category: "Swing Trading", signalKey: "SWG_RSI_DIVERGE_SHORT", tradingCategory: "swing_trading", templateFamily: "swg_rsi_divergence", primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.3, tpPct: 2.8, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 652, name: "SWG_EMA_Pullback_Long",   category: "Swing Trading", signalKey: "SWG_EMA_PULLBACK_LONG", tradingCategory: "swing_trading", templateFamily: "swg_ema_pullback",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.4, tpPct: 3.2, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 653, name: "SWG_EMA_Pullback_Short",  category: "Swing Trading", signalKey: "SWG_EMA_PULLBACK_SHORT",tradingCategory: "swing_trading", templateFamily: "swg_ema_pullback",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.4, tpPct: 3.2, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 654, name: "SWG_Struct_HH_Long",      category: "Swing Trading", signalKey: "SWG_STRUCT_HH_LONG",    tradingCategory: "swing_trading", templateFamily: "swg_struct_break",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.7, tpPct: 3.8, holdMinutes: 7200,  cooldownMin: 300, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 655, name: "SWG_Struct_LL_Short",     category: "Swing Trading", signalKey: "SWG_STRUCT_LL_SHORT",   tradingCategory: "swing_trading", templateFamily: "swg_struct_break",   primaryBarInterval: "4h", requiresHtf: true,  slPct: 1.7, tpPct: 3.8, holdMinutes: 7200,  cooldownMin: 300, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 656, name: "SWG_BB_MeanRev_Long",     category: "Swing Trading", signalKey: "SWG_BB_MEANREV_LONG",   tradingCategory: "swing_trading", templateFamily: "swg_mean_revert_bb", primaryBarInterval: "4h", requiresHtf: false, slPct: 1.0, tpPct: 2.5, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 657, name: "SWG_BB_MeanRev_Short",    category: "Swing Trading", signalKey: "SWG_BB_MEANREV_SHORT",  tradingCategory: "swing_trading", templateFamily: "swg_mean_revert_bb", primaryBarInterval: "4h", requiresHtf: false, slPct: 1.0, tpPct: 2.5, holdMinutes: 2880,  cooldownMin: 180, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 658, name: "SWG_ATR_Vol_Long",        category: "Swing Trading", signalKey: "SWG_ATR_VOL_LONG",      tradingCategory: "swing_trading", templateFamily: "swg_atr_volatility", primaryBarInterval: "4h", requiresHtf: false, slPct: 2.0, tpPct: 4.5, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
  { id: 659, name: "SWG_ATR_Vol_Short",       category: "Swing Trading", signalKey: "SWG_ATR_VOL_SHORT",     tradingCategory: "swing_trading", templateFamily: "swg_atr_volatility", primaryBarInterval: "4h", requiresHtf: false, slPct: 2.0, tpPct: 4.5, holdMinutes: 4320,  cooldownMin: 240, confluenceMin: 6, defaultLeverage: 8, researchOnly: true },
];
// ─── Categories 4–8: stubs (scored in subsequent PRs) ────────────────────────
 ...
 */
export const LEGACY_CORE_CATEGORY_MAP: ReadonlyMap<number, import("@/lib/trading/futuresStratTypes").TradingCategoryId> =
  new Map([
    [91,  "trend_trading"],
    [92,  "trend_trading"],
    [95,  "breakout_trading"],
