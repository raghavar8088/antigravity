...
import type { BtcFtTemplateId, FuturesStratDef, RegimeTag } from "@/lib/trading/futuresStratTypes";

export type { BtcFtTemplateId } from "@/lib/trading/futuresStratTypes";
