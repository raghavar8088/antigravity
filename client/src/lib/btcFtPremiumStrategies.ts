...
export const BTC_FT_PREMIUM_DEFS: ReadonlyArray<FuturesStratDef> = [
  ...
  // -------------------- Strategy 13: Micro VWAP Reclaim/Reject --------------------
  {
    id: 524,
    name: "PRM_MicroVWAP_Reclaim_Long",
    category: "PREMIUM 1m Scalp",
    signalKey: "BTCFT_PRM_MICRO_VWAP_RECLAIM_0_LONG",
    slPct: 0.22,
    tpPct: 0.48,
    cooldownMin: 8,
    holdMinutes: 14,
    ...
    requiresHtf: false,
    regimes: ["chop", "trendLow"],
    btcFtTemplate: "PRM_MICRO_VWAP_RECLAIM",
    btcFtVariant: 0,
    tier: "premium",
    styles: ["scalp"],
    playbooks: ["range"],
    templateFamily: "PRM_MICRO_VWAP_RECLAIM",
    primaryBarInterval: "1m",
  },
  {
    id: 525,
    name: "PRM_MicroVWAP_Reject_Short",
    category: "PREMIUM 1m Scalp",
    signalKey: "BTCFT_PRM_MICRO_VWAP_RECLAIM_0_SHORT",
    slPct: 0.22,
    tpPct: 0.48,
    cooldownMin: 8,
    holdMinutes: 14,
  ...
  // -------------------- Strategy 14: Liquidity Sweep Scalp --------------------
  {
    id: 526,
    name: "PRM_LiquiditySweep_Scalp_Long",
    category: "PREMIUM 1m Scalp",
    signalKey: "BTCFT_PRM_LIQUIDITY_SWEEP_SCALP_0_LONG",
    slPct: 0.24,
    tpPct: 0.52,
    cooldownMin: 10,
    holdMinutes: 16,
    ...
    requiresHtf: false,
    regimes: ["chop", "trendLow"],
    btcFtTemplate: "PRM_LIQUIDITY_SWEEP_SCALP",
    btcFtVariant: 0,
    tier: "premium",
    styles: ["scalp"],
    playbooks: ["range"],
    templateFamily: "PRM_LIQUIDITY_SWEEP_SCALP",
    primaryBarInterval: "1m",
  },
  {
    id: 527,
    name: "PRM_LiquiditySweep_Scalp_Short",
    category: "PREMIUM 1m Scalp",
    signalKey: "BTCFT_PRM_LIQUIDITY_SWEEP_SCALP_0_SHORT",
    slPct: 0.24,
    tpPct: 0.52,
    cooldownMin: 10,
    holdMinutes: 16,
