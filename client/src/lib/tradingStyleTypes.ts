...
export type { TradingStyleId, PlaybookId } from "@/lib/futuresStratTypes";

/** Full profile for a time-horizon desk module. */
export type TradingStyleProfile = {
  id: import("@/lib/futuresStratTypes").TradingStyleId;
  label: string;
...
export type PlaybookProfile = {
  id: import("@/lib/futuresStratTypes").PlaybookId;
  label: string;
