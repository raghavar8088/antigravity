 ...
 * Core basket (popular archetypes) plus extended BTC FT template proof IDs (200–219); keep in sync everywhere.
 */
...
export const BTC_FT_EXTENDED_PROOF_STRATEGY_IDS: readonly number[] =
  BTC_FT_EXTENDED_DEFS_PROOF.map((d) => d.id);
...
export const BTC_FUTURE_TRADING_STRATEGY_IDS: number[] = [
  ...
  ...BTC_FT_EXTENDED_PROOF_STRATEGY_IDS,
];
