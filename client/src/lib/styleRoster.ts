...
import type { FuturesStratDef, TradingStyleId, PlaybookId } from "@/lib/futuresStratTypes";
import {
...
import { getTradingStyleProfile } from "@/lib/tradingStyleRegistry";
import { getPlaybookProfile, categoryPassesPlaybook } from "@/lib/playbookRegistry";
