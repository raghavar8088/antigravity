...
import { BTC_FUTURE_TRADING_STRATEGY_IDS } from "@/lib/trading/btcFtRoster";
import { dbRowToBtcFuturesTrade } from "@/lib/portfolio/paperTradesMapper";
import type { PaperTradeDbRow } from "@/lib/portfolio/paperTradesTypes";
import {
  runPaperDeskReplay,
  summarizeReplayTrades,
  type PaperReplayStats,
} from "@/lib/analytics/futuresReplayEngine";
import {
  filterCandlesByTimeRange,
  loadReplayFixture,
  utcDayBoundsMs,
} from "@/lib/analytics/futuresReplayFixtures";
import { getTradesCollection, isMongoConfigured } from "@/lib/broker/mongoTradesClient";
import { isProbeOrBootstrapTrade } from "@/lib/analytics/futuresSessionMetrics";
...
export { deskReplayGateEnabled } from "@/lib/analytics/futuresReplayGate";
